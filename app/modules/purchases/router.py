...
@router.post(
    ...
    description=(
        "Registra una nueva entrada de mercancía al inventario. "
        "Incrementa el stock de cada producto de forma atómica. "
...
@router.get(
    ...
    description="Lista paginada de órdenes de compra del tenant. Solo rol `admin`.",
)
...
@router.get(
    ...
    description="Retorna el detalle completo de una orden con los nombres de los productos. Solo rol `admin`.",
)
